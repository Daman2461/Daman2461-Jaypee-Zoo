...
<input type="text" style="font-size: 25px"name="CLname" placeholder="Last Name"> 
<p style="font-size:40px">Enter the Customer ID </p>
   <input type="number" style="font-size: 25px"name="Cid" placeholder="Customer ID"> <input type = 'submit' name='submit' value='submit' style="font-size: 25px"formaction="clname.php"/><br/>
...
if(isset($_POST['submit']))
{
            ...
            $q2=" update customer set CLname='$CLname' where Cid='$Cid'";
